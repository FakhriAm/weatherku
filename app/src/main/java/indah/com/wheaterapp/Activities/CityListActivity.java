...
import indah.com.wheaterapp.api.WeatherTask;
...
public class CityListActivity extends AppCompatActivity implements WeatherTask.MyAsyncTaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (preferencesManager.isFirstTime()) {
            ...
            preferencesManager.addItem(getString(R.string.bandung));
            preferencesManager.addItem(getString(R.string.tangerang));
            preferencesManager.addItem(getString(R.string.jakarta));
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(CityListActivity.this)
                        .setTitle("Tambahkan Kota")
                        .setMessage("Ketikan nama kota dengan benar")
                        .setView(input)
    ...
    public void onPostExecuteTask(WeatherResponse result, boolean isSuccessful) {
        ...
        if (result == null || result.getError() != null) {
            Toast.makeText(CityListActivity.this, "nama kota tidak ditemukan ! , coba cek ulang penulisan", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(CityListActivity.this, " Berhasil ditambahkan!", Toast.LENGTH_LONG).show();
